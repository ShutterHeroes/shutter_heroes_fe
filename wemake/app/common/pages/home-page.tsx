...
export const meta: Route.MetaFunction = () => {
  return [
    { title: '셔터 히어로즈 - 동물 관찰 정보 공유 플랫폼' },
    { name: 'description', content: 'AI 기반 동물 인식으로 야생동물 출동 기록을 공유하세요' },
  ];
};
  ...
  useEffect(() => {
    const fetchRecentSightings = async () => {
      try {
        ...
        console.error('최근 출동 기록 조회 에러:', err);
      } finally {
        setIsLoading(false);
      }
    };
        ...
        <div className="container mx-auto max-w-6xl text-center space-y-8">
          ...
          <BlurFade delay={0.2} inView>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              사진 한 장으로 동물을 인식하고, 출동 기록을 공유하세요.
              <br />
          ...
          <BlurFade delay={0.2} inView>
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4 pt-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  다른 사용자들과 출동 기록을 공유하고 야생동물 관찰 경험을 나누세요
                </p>
              </CardContent>
            </Card>
          </BlurFade>
          ...
          <BlurFade delay={0.3} inView>
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="space-y-4 pt-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  관찰 정보가 쌓여 생태계 연구와 보존에 기여할 수 있습니다
                </p>
              </CardContent>
            </Card>
          </BlurFade>
      ...
      <section className="container mx-auto max-w-6xl px-4">
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-bold">최근 출동 기록</h2>
