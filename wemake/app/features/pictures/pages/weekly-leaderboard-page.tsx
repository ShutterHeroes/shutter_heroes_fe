  ...
  return [
    {
      title: `Best of week ${date
        ...
        .endOf("week")
        .toLocaleString(DateTime.DATE_SHORT)} | Shutter Heroes`,
    },
  ];
};
    ...
    <div className="space-y-10">
      ...
      <div className="flex items-center justify-center gap-2">
        <Button variant="secondary" asChild>
          <Link
            to={`/pictures/leaderboards/weekly/${previousWeek.year}/${previousWeek.weekNumber}`}
          >
        ...
        {!isToday ? (
          <Button variant="secondary" asChild>
            <Link
              to={`/pictures/leaderboards/weekly/${nextWeek.year}/${nextWeek.weekNumber}`}
            >
